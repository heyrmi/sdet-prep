# DSA — 189 runnable problems, pattern-organized
...
└── src/main/java/ra/hul/dsa/    189 problems across 26 topic/pattern packages
```
...
## Coverage (189 problems, all ~15 canonical patterns)

**Data structures:** arrays (14), strings (9), hashmap (4), linkedlist (6), stack (5), queue (1),
tree (6), trie (5), heap (12), graph (14), unionfind (5), advancedtrees (4 — Fenwick/segment).
...
bitmanipulation (9), matrix (9), sorting (1), recursion (1).
